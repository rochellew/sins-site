...
var CharacterProfile = function (_a) {
    var name = _a.name, race = _a.race, classRole = _a.classRole, level = _a.level, status = _a.status, description = _a.description, imageSrc = _a.imageSrc, keyStats = _a.keyStats;
    var statusClass = status.toLowerCase();
    return (react_1["default"].createElement("article", { className: "character-profile " + statusClass },
        ...
        react_1["default"].createElement("div", { className: "profile-details" },
            ...
            react_1["default"].createElement("p", null,
                ...
                " ",
                level)),
        react_1["default"].createElement("div", { className: "key-stats" },
            react_1["default"].createElement("div", { className: "stat-box" },
                react_1["default"].createElement("span", { className: "stat-value" }, keyStats.hp),
                react_1["default"].createElement("span", { className: "stat-label" }, "HP")),
            react_1["default"].createElement("div", { className: "stat-box" },
                react_1["default"].createElement("span", { className: "stat-value" }, keyStats.ac),
                react_1["default"].createElement("span", { className: "stat-label" }, "AC")),
            react_1["default"].createElement("div", { className: "stat-box" },
                react_1["default"].createElement("span", { className: "stat-value" }, keyStats.passivePerception),
                react_1["default"].createElement("span", { className: "stat-label" }, "Passive Perception"))),
